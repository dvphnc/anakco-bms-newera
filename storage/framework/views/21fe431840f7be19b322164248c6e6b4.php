            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="requestor_relationship" name="requestor_relationship" class="form-control" style="height:48px;border:1.5px solid #d1d5db;border-radius:8px;font-family:'Poppins',sans-serif;font-size:1rem;padding:0 1rem;background:#fff">
                        ...
                        <?php $__currentLoopData = ['Son','Daughter','Parent / Guardian','Spouse','Sibling','Cousin','Nephew / Niece','Legal Guardian','Attorney-in-Fact (SPA)','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rel); ?>"><?php echo e($rel); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
(function () {
    ...
    document.getElementById('docRequestForm').addEventListener('submit', function (e) {
        ...
        axios.post('<?php echo e(route('portal.store')); ?>', fd, {
