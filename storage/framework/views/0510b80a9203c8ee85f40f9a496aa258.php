    ...
    <div id="tab-medicine-inventory" class="tab-content">
            ...
            <div class="form-panel-inner">
                ...
                <form method="POST" action="<?php echo e(route('committees.storeSpecific', $committee['slug'])); ?>">
                    ...
                    <div class="form-grid-3" style="gap:12px">
                        ...
                        <div class="form-group"><label class="form-label">Unit <span style="color:var(--crimson)">*</span></label><select name="unit" class="form-control" required><?php $__currentLoopData = ['tablets','capsules','vials','sachets','bottles','ampules','boxes','strips','packs','other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option><?php echo e($u); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-weight:600;color:var(--navy)"><?php echo e($med->medicine_name); ?></td>
                    <td class="td-muted"><?php echo e($med->generic_name ?? '—'); ?></td>
                    <td style="text-align:right;font-weight:700;color:<?php echo e($med->isLowStock() ? 'var(--crimson)' : 'var(--navy)'); ?>">
                        <?php echo e(number_format($med->current_stock)); ?>

                        <?php if($med->isLowStock()): ?><i class="fas fa-triangle-exclamation" style="margin-left:4px;color:var(--crimson);font-size:10px" title="Low stock!"></i><?php endif; ?>
                    </td>
                    <td class="td-muted"><?php echo e($med->unit); ?></td>
                    <td class="td-muted"><?php echo e(number_format($med->reorder_level)); ?></td>
                    <td class="<?php echo e($med->isExpired() ? 'td-danger' : 'td-muted'); ?>">
