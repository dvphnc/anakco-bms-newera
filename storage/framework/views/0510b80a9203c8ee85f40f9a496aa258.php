...
<div class="page-header">
    <div style="display:flex;align-items:center;gap:14px">
        <div style="width:46px;height:46px;border-radius:var(--radius);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;background:<?php echo e($committee['color']); ?>18;color:<?php echo e($committee['color']); ?>">
            <i class="fas <?php echo e($committee['icon']); ?>"></i>
        </div>
        <div>
            <h1 class="page-title"><?php echo e($committee['name']); ?></h1>
            <p class="page-subtitle">Chairperson: <?php echo e($committee['chair']); ?></p>
        </div>
    </div>
</div>
...
<div class="card">
    <div style="display:flex;border-bottom:2px solid var(--border);padding:0 20px;gap:4px;overflow-x:auto">
        ...
        <button class="tab-btn <?php echo e($loop->first ? 'active' : ''); ?>"
            ...
            <i class="<?php echo e($tab['icon']); ?>" style="font-size:12px"></i>
    ...
    <div id="tab-records" class="tab-content active">
        ...
        <div style="padding:16px 20px">
            <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle);margin-bottom:12px"><i class="fas fa-images" style="color:var(--gold)"></i> Photos (<?php echo e($photos->count()); ?>)</div>
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:10px">
                ...
                <div style="border-radius:var(--radius-sm);overflow:hidden;border:1px solid var(--border)">
                    ...
                    <a href="<?php echo e(asset('storage/'.$photo->file_path)); ?>" target="_blank">
                        <img src="<?php echo e(asset('storage/'.$photo->file_path)); ?>" style="width:100%;height:90px;object-fit:cover;display:block">
                    </a>
                    <?php endif; ?>
                    <div style="padding:6px 8px"><div style="font-size:11px;font-weight:600;color:var(--text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap"><?php echo e($photo->title); ?></div></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div style="border-top:1px solid var(--border)">
            <div style="padding:12px 20px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle)"><i class="fas fa-file-alt" style="color:var(--gold)"></i> Documents (<?php echo e($docRecords->count()); ?>)</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if($rec->file_path): ?><a href="<?php echo e(asset('storage/'.$rec->file_path)); ?>" target="_blank" class="btn btn-secondary btn-sm btn-icon"><i class="fas fa-download"></i></a><?php else: ?><span class="td-muted">—</span><?php endif; ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody></table>
        </div>
    ...
    <div id="tab-activities" class="tab-content">
        ...
        <tbody>
            ...
            <tr>
                <td><div style="font-weight:600"><?php echo e($act->title); ?></div><?php if($act->description): ?><div class="td-muted"><?php echo e($act->description); ?></div><?php endif; ?></td>
        ...
        <?php else: ?><div class="empty-state"><i class="fas fa-calendar-check"></i><p>No activities logged yet.</p></div><?php endif; ?>
    </div>
    ...
    <div id="tab-accomplishments" class="tab-content">
        ...
        <div style="padding:16px 20px;display:flex;flex-direction:column;gap:12px">
            ...
            <div style="padding:14px 16px;background:var(--surface2);border:1px solid var(--border);border-left:4px solid <?php echo e($committee['color']); ?>;border-radius:var(--radius-sm)">
                <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap">
                    <div>
                        <div style="font-weight:600;font-size:13.5px;margin-bottom:3px"><?php echo e($acc->title); ?></div>
                        <?php if($acc->description): ?><div class="td-muted" style="margin-bottom:6px"><?php echo e($acc->description); ?></div><?php endif; ?>
                        <div style="display:flex;gap:16px;flex-wrap:wrap">
                            <span style="font-size:11px;color:var(--text-subtle)"><i class="fas fa-calendar-alt" style="margin-right:4px"></i><?php echo e(\Carbon\Carbon::parse($acc->activity_date)->format('M d, Y')); ?></span>
                            <?php if($acc->location): ?><span style="font-size:11px;color:var(--text-subtle)"><i class="fas fa-location-dot" style="margin-right:4px"></i><?php echo e($acc->location); ?></span><?php endif; ?>
                        </div>
                    </div>
        ...
        <?php else: ?><div class="empty-state"><i class="fas fa-trophy"></i><p>No accomplishments logged yet.</p></div><?php endif; ?>
    </div>
    ...
    <div id="tab-attendance" class="tab-content">
        ...
        <?php else: ?><div class="empty-state"><i class="fas fa-users"></i><p>No attendance records yet.</p></div><?php endif; ?>
    </div>
    ...
    <div id="tab-inventory" class="tab-content">
        ...
        <?php else: ?><div class="empty-state"><i class="fas fa-boxes-stacked"></i><p>No inventory items yet.</p></div><?php endif; ?>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div style="display:flex;align-items:center;gap:8px">
                        <div class="progress-bar-wrap" style="flex:1;min-width:60px"><div class="progress-bar" style="width:<?php echo e($p->completion_percentage); ?>%;background:<?php echo e($p->completion_percentage >= 100 ? '#16a34a' : 'var(--gold)'); ?>"></div></div>
                        <span style="font-size:11px;color:var(--text-muted)"><?php echo e($p->completion_percentage); ?>%</span>
                    </div>
                </td>
            ...
            <div style="padding:16px;border:1px solid var(--border);border-radius:var(--radius);background:var(--surface2)">
                <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px">
                    <div>
                        ...
                        <div class="td-muted"><?php echo e($ec->location); ?></div>
                    </div>
                ...
                <div class="progress-bar-wrap"><div class="progress-bar" style="width:<?php echo e($occ); ?>%;background:<?php echo e($occ >= 90 ? 'var(--crimson)' : ($occ >= 70 ? 'var(--gold)' : '#16a34a')); ?>"></div></div>
                <?php if($ec->contact_person): ?>
                <div style="font-size:11px;color:var(--text-muted);margin-top:8px"><i class="fas fa-user" style="margin-right:4px"></i><?php echo e($ec->contact_person); ?> — <?php echo e($ec->contact_number ?? '—'); ?></div>
                <?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
