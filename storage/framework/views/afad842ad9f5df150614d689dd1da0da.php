...
<body>
    <div class="error-card">
        ...
        <div>
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary"><i class="fas fa-house"></i> Dashboard</a>
        </div>
        <div class="barangay-label">BARANGAY NEW ERA MANAGEMENT SYSTEM</div>
    </div>
</body>
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views\errors\419.blade.php ENDPATH**/ ?>