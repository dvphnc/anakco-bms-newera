  ...
  <tr>
    <td align="center">
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td style="background:<?php echo e($bannerGrad); ?>;padding:20px 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
        ...
        <tr>
          <td style="background:#ffffff;padding:28px 28px 8px;">
            ...
            <p style="font-size:15px;color:#374151;margin:0 0 18px;">
              Hello, <strong style="color:#0D2144;"><?php echo e($residentName); ?></strong>.
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr style="background:#ffffff;">
                <td style="padding:11px 16px;font-size:10.5px;font-weight:700;text-transform:uppercase;
                           ...
                           <?php echo e($preferredDate || (isset($feePaid) && $feePaid !== null) ? 'border-bottom:1px solid #f3f4f6;' : ''); ?>

                           vertical-align:middle;">
                  Status
                </td>
                <td style="padding:11px 16px;font-size:13px;font-weight:700;color:<?php echo e($statusColor); ?>;
                           text-align:right;
                           <?php echo e($preferredDate || (isset($feePaid) && $feePaid !== null) ? 'border-bottom:1px solid #f3f4f6;' : ''); ?>

                           vertical-align:middle;">
                  <?php echo e($newStatus); ?>
              ...
              <tr style="background:#fafbfc;">
                <td style="padding:11px 16px;font-size:10.5px;font-weight:700;text-transform:uppercase;
                           letter-spacing:.07em;color:#9ca3af;
                           <?php echo e((isset($feePaid) && $feePaid !== null) ? 'border-bottom:1px solid #f3f4f6;' : ''); ?>

                           vertical-align:middle;">
                  <?php echo e($newStatus === 'Ready' ? 'Pick-up Date' : 'Preferred Date'); ?>
                ...
                <td style="padding:11px 16px;font-size:13px;font-weight:500;color:#1f2937;
                           ...
                           vertical-align:middle;">
                  <?php echo e(\Carbon\Carbon::parse($preferredDate)->format('m/d/Y')); ?>

                </td>
              </tr>
              <?php endif; ?>

              <?php if(isset($feePaid) && $feePaid !== null && in_array($newStatus, ['Ready','Released'])): ?>
              
              <tr style="background:<?php echo e($preferredDate ? '#ffffff' : '#fafbfc'); ?>;">
                <td style="padding:11px 16px;font-size:10.5px;font-weight:700;text-transform:uppercase;
                ...
                <td style="padding:11px 16px;font-size:13px;font-weight:700;vertical-align:middle;
                           color:<?php echo e($feePaid > 0 ? '#16a34a' : '#9ca3af'); ?>;text-align:right;">
              ...
              <tr style="background:#fafbfc;">
                ...
                <td style="padding:11px 16px;font-size:13px;font-weight:400;color:#9ca3af;
                  ...
                  <?php echo e(now()->format('m/d/Y \a\t h:i A')); ?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:14px 16px;font-size:13px;line-height:1.65;color:#374151;">
                  ...
                  Our staff will review your <?php echo e(strtolower($typeLabel)); ?> and begin processing it.
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:14px 16px;font-size:13px;line-height:1.65;color:#374151;">
                  ...
                  Our staff are currently working on your <?php echo e(strtolower($typeLabel)); ?>.
              ...
              <tr>
                <td style="padding:14px 16px;font-size:13px;line-height:1.65;color:#374151;">
                  ...
                  <?php if($preferredDate): ?>
                    ...
                    <strong><?php echo e(\Carbon\Carbon::parse($preferredDate)->format('m/d/Y')); ?></strong>.
                  <?php endif; ?>
                  <?php if(isset($feePaid) && $feePaid > 0): ?>
                    <br><br>Please prepare the document fee of
                    <strong style="color:#15803d;">₱<?php echo e(number_format($feePaid, 2)); ?></strong>.
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:14px 16px;font-size:13px;line-height:1.65;color:#374151;">
                  ...
                  Your <?php echo e(strtolower($typeLabel)); ?> has been officially released. Please keep it in a safe place.
        ...
        <tr>
          <td style="background:#ffffff;padding:20px 28px 8px;text-align:center;">
            ...
            <p style="margin:10px 0 0;font-size:12px;color:#9ca3af;">
              Reference: <span style="font-family:monospace;font-weight:700;color:#0D2144;"><?php echo e($requestNumber); ?></span>
            </p>
          </td>
        </tr>
