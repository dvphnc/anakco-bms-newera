...
<div class="page-header">
    ...
    <a href="<?php echo e(route('portal.index')); ?>" class="btn btn-outline btn-sm" target="_blank">
...
<form method="GET" action="<?php echo e(route('appointments.index')); ?>" class="filter-bar">
    <div class="filter-group">
        <label>Search</label>
        <input type="text" name="search" class="filter-control" placeholder="Name or number…" value="<?php echo e(request('search')); ?>">
    </div>
    <div class="filter-group">
        <label>Status</label>
    ...
    <div class="filter-group">
        ...
        <select name="document_type" class="filter-control">
            ...
            <?php $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($dt); ?>" <?php echo e(request('document_type') === $dt ? 'selected' : ''); ?>><?php echo e($dt); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="filter-actions">
        <button type="submit" class="btn btn-navy btn-sm"><i class="fas fa-filter"></i> Filter</button>
        <a href="<?php echo e(route('appointments.index')); ?>" class="btn btn-outline btn-sm">Reset</a>
    </div>
</form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size:.74rem;color:#9ca3af"><?php echo e($apt->contact_number); ?></div>
                    </td>
                    <td><div class="apt-doc"><?php echo e($apt->document_type); ?></div></td>
                    <td><?php echo e($apt->preferred_date->format('M d, Y')); ?></td>
                    <td style="font-size:.78rem;color:#9ca3af"><?php echo e($apt->created_at->format('M d, Y')); ?></td>
                    <td>
