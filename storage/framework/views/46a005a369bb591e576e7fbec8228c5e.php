...
<div class="page-header no-print">
    ...
    <div class="page-actions">
        ...
        <a href="<?php echo e(route('businesses.edit', $business)); ?>" class="btn btn-secondary">
...
<div class="no-print" style="display:flex;align-items:center;gap:12px;background:var(--navy);border-radius:var(--radius);padding:12px 18px;margin-bottom:20px">
    ...
    <div style="flex:1;min-width:0">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:rgba(255,255,255,0.5);margin-bottom:2px">Permit Number</div>
        <div id="bizRefNum" style="font-size:17px;font-weight:700;color:#fff;font-family:'Courier New',monospace;letter-spacing:0.05em"><?php echo e($business->permit_number); ?></div>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="card">
            <div style="background:linear-gradient(135deg,var(--navy),var(--navy-mid));padding:24px 20px;text-align:center">
                ...
                <div style="font-size:12px;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.45);margin-bottom:4px">
                    <?php echo e($business->permit_number); ?>
                ...
                <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-bottom:12px">
                    <?php echo e($business->business_type); ?>
                ...
                ?>
                <span class="badge <?php echo e($cls); ?>"><?php echo e($business->status); ?></span>
            </div>
            ...
            <div style="padding:16px 20px;border-top:1px solid var(--border);text-align:center">
                ...
                <a href="<?php echo e(url('/verify/business/' . $business->permit_number)); ?>" target="_blank" title="Click to verify this permit">
                    <?php echo QrCode::size(140)->generate(
                ...
                <div style="font-size:13px;color:var(--text-muted);margin-top:6px">
                    Scan to verify &nbsp;·&nbsp;
                    <a href="<?php echo e(url('/verify/business/' . $business->permit_number)); ?>" target="_blank" style="color:var(--navy);font-weight:600">
            ...
            <?php if($business->permit_date && $business->expiry_date): ?>
            <?php
            ...
            <div style="padding:14px 16px;border-top:1px solid var(--border)">
                <div style="display:flex;justify-content:space-between;font-size:13px;color:var(--text-subtle);margin-bottom:6px">
                    <span>Validity</span>
                    <span><?php echo e($end->isPast() ? 'Expired' : $end->diffForHumans()); ?></span>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="display:flex;flex-direction:column;gap:8px">
                <a href="<?php echo e(route('businesses.edit', $business)); ?>" class="btn btn-secondary" style="justify-content:flex-start">
                ...
                <form method="POST" action="<?php echo e(route('businesses.update', $business)); ?>">
                    ...
                    <input type="hidden" name="business_name" value="<?php echo e($business->business_name); ?>">
                    <input type="hidden" name="business_type" value="<?php echo e($business->business_type); ?>">
                    <input type="hidden" name="business_address" value="<?php echo e($business->business_address); ?>">
                    <input type="hidden" name="owner_name" value="<?php echo e($business->owner_name); ?>">
                    <input type="hidden" name="permit_date" value="<?php echo e($business->permit_date); ?>">
                    <input type="hidden" name="expiry_date" value="<?php echo e($business->expiry_date); ?>">
                ...
                <form method="POST" action="<?php echo e(route('businesses.destroy', $business)); ?>"
                      data-confirm="Delete permit for <?php echo e($business->business_name); ?>? This cannot be undone."
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--border)">
                ...
                <div style="font-size:15px;color:var(--text)"><?php echo e($business->business_address); ?></div>
            </div>
            <?php if($business->ownerResident): ?>
            <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border)">
                ...
                <a href="<?php echo e(route('residents.show', $business->ownerResident)); ?>"
                   style="display:flex;align-items:center;gap:10px;color:var(--navy)">
                    <div style="width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,var(--navy),var(--navy-mid));display:flex;align-items:center;justify-content:center;font-weight:700;color:#fff;font-size:13px;flex-shrink:0">
                        <?php echo e(strtoupper(substr($business->ownerResident->first_name, 0, 1))); ?>

                    </div>
                    <div>
                        <div style="font-weight:600;font-size:14px"><?php echo e($business->ownerResident->full_name); ?></div>
...
<div class="permit-page">
    <div class="permit-border">
        <img src="<?php echo e(asset('images/bne-logo.png')); ?>" class="permit-watermark" alt="">
        <div class="permit-content">

            
            <div class="permit-header">
                <img src="<?php echo e(asset('images/qc-seal.png')); ?>" class="permit-logo" alt="QC Seal">
                ...
                <img src="<?php echo e(asset('images/bne-logo.png')); ?>" class="permit-logo" alt="BNE Seal">
            </div>

            <div class="permit-type">Barangay Business Clearance</div>
            <div class="permit-num">Permit No.: <?php echo e($business->permit_number); ?></div>

            
            <div class="permit-body">
                <div class="permit-details">
                    <div class="permit-row"><span class="lbl">Business Name:</span><span class="val"><strong><?php echo e($business->business_name); ?></strong></span></div>
                    <div class="permit-row"><span class="lbl">Business Type:</span><span class="val"><?php echo e($business->business_type); ?></span></div>
                    <div class="permit-row"><span class="lbl">Business Address:</span><span class="val"><?php echo e($business->business_address); ?></span></div>
                    <div class="permit-row"><span class="lbl">Owner / Operator:</span><span class="val"><strong><?php echo e($business->owner_name); ?></strong></span></div>
                    <div class="permit-row"><span class="lbl">Contact Number:</span><span class="val"><?php echo e($business->owner_contact ?? '—'); ?></span></div>
                    <div class="permit-row"><span class="lbl">Date Issued:</span><span class="val"><?php echo e($permitDate?->format('F d, Y') ?? '—'); ?></span></div>
                    <div class="permit-row"><span class="lbl">Valid Until:</span><span class="val"><strong><?php echo e($permitExpiry?->format('F d, Y') ?? '—'); ?></strong></span></div>
                    <div class="permit-row"><span class="lbl">Status:</span><span class="val"><strong><?php echo e($business->status); ?></strong></span></div>
                </div>
                <div class="permit-qr">
                    <?php echo QrCode::size(120)->generate(
                        url('/verify/business/' . $business->permit_number)
                    ); ?>
            ...
            <div class="permit-validity">
                ...
                <strong>valid from <?php echo e($permitDate?->format('F d, Y') ?? '—'); ?> to <?php echo e($permitExpiry?->format('F d, Y') ?? '—'); ?></strong>,
            ...
            <div class="permit-footer">
                ...
                <div class="permit-sig">
                    ...
                    <div class="permit-sig-name"><?php echo e($permitOfficialName); ?></div>
            ...
            <div style="margin-top:14px;padding-top:10px;border-top:1px dashed #999;font-size:8pt;color:#555;display:flex;gap:32px">
                ...
                <span>Date: <?php echo e(now()->format('m/d/Y')); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\anakco_bms\resources\views\businesses\businesses-show.blade.php ENDPATH**/ ?>