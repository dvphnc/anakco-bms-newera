...
<header class="portal-header">
    ...
    <nav class="portal-nav">
        <a href="<?php echo e(route('portal.request')); ?>"><i class="fas fa-file-plus"></i> Request Document</a>
        <a href="<?php echo e(route('portal.track')); ?>"><i class="fas fa-search"></i> Track Status</a>
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        <?php else: ?>
...
<main class="portal-main">
    <?php if(session('success')): ?>
        <div class="p-alert p-alert-success"><i class="fas fa-check-circle"></i> <?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="p-alert p-alert-error"><i class="fas fa-exclamation-circle"></i> <?php echo e(session('error')); ?></div>
    <?php endif; ?>
...
<footer class="portal-footer">
    &copy; <?php echo e(date('Y')); ?> Barangay New Era, District VI, Quezon City. All rights reserved.
</footer>

<?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH D:\laragon\www\anakco_bms\resources\views/layouts/portal.blade.php ENDPATH**/ ?>