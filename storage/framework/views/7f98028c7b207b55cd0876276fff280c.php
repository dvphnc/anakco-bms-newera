...
<footer class="portal-footer" aria-label="Site footer">
    <div class="footer-inner">
        ...
        <div class="footer-col">
            ...
            <a href="<?php echo e(route('portal.index')); ?>"><i class="fas fa-home"></i> Portal Home</a>
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('portal.index')); ?>#faq"><i class="fas fa-circle-question"></i> FAQ</a>
        </div>
        ...
        <div class="footer-health">
            ...
            <div class="health-row">
                <div class="health-dot <?php echo e($ftrDbOk ? 'ok' : 'offline'); ?>"></div>
                <div>
                    <span class="health-label">Database</span><br>
                    <span><?php echo e($ftrDbOk ? 'Online &amp; Connected' : 'Connection Error'); ?></span>
                </div>
            </div>

            <div class="health-row">
                <div class="health-dot <?php echo e($ftrBackupOk ? 'ok' : 'warn'); ?>"></div>
                <div>
                    <span class="health-label">Last Backup</span><br>
                    <span><?php echo e($ftrBackupAgo); ?></span>
                </div>
            </div>
