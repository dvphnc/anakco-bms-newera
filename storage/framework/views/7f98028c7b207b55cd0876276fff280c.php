...
=======
    <nav class="portal-nav" aria-label="Main navigation">
        ...
        <a href="<?php echo e(route('portal.track')); ?>"><i class="fas fa-search"></i> Track Status</a>
        <a href="<?php echo e(route('portal.request')); ?>" class="nav-gold">
            <i class="fas fa-file-plus"></i> Request Document
        </a>
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="nav-ghost">
                <i class="fas fa-tachometer-alt"></i> Dashboard
            </a>
        <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="nav-ghost">
>>>>>>> Stashed changes
...
<div id="mobileDrawer" class="mobile-drawer" role="dialog" aria-modal="true" aria-label="Navigation menu">
    ...
    <div class="drawer-panel">
        ...
        <nav class="drawer-nav">
            ...
            <a href="<?php echo e(route('portal.track')); ?>">
...
<footer class="portal-footer">
    <div class="footer-grid">
        ...
        <div class="footer-col">
            <h4>Services</h4>
            <a href="<?php echo e(route('portal.request')); ?>">Request Document</a>
            <a href="<?php echo e(route('portal.track')); ?>">Track Appointment</a>
            <a href="<?php echo e(route('portal.index')); ?>">How It Works</a>
        </div>
        <div class="footer-col">
            <h4>Quick Links</h4>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>">Staff Dashboard</a>
            <?php else: ?>
    ...
    <div class="footer-bottom">
        &copy; <?php echo e(date('Y')); ?> Barangay New Era, District VI, Quezon City &nbsp;&middot;&nbsp; All rights reserved.
    </div>
</footer>
...
document.addEventListener('DOMContentLoaded', function () {
    portalToast(<?php echo json_encode(session('success'), 15, 512) ?>, 'success');
});
<?php endif; ?>
<?php if(session('error')): ?>
document.addEventListener('DOMContentLoaded', function () {
    portalToast(<?php echo json_encode(session('error'), 15, 512) ?>, 'error');
});
<?php endif; ?>
</script>
