    ...
    <div class="verify-card">
        ...
        <div class="details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo e($business->permit_date ? \Carbon\Carbon::parse($business->permit_date)->format('m/d/Y') : '—'); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Valid Until</span>
                <span class="detail-value <?php echo e($isExpired ? 'expired-text' : 'valid-text'); ?>">
                    <?php echo e($expiry?->format('m/d/Y') ?? '—'); ?>
        ...
        <div class="verify-footer">
            ...
            Verified on <?php echo e(now()->format('m/d/Y g:i A')); ?><br>
