...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    <?php $__currentLoopData = ['Active','Under Investigation','Mediated','Settled','Referred to Higher Authority']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-grid-2 mb-6">
            <div class="form-group">
                ...
                <input type="text" name="responding_officer" class="form-control" value="<?php echo e(old('responding_officer')); ?>" placeholder="e.g. Tanod Juan Dela Cruz">
            </div>
        </div>
    </div>
</div>
