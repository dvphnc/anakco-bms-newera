...
<div class="p-card">
    <div class="confirm-wrap">
        ...
        <div class="submitted-stamp">
            ...
            Submitted on <strong><?php echo e($appointment->created_at->format('m/d/Y')); ?></strong>
        ...
        <table class="detail-table">
            ...
            <tr>
                ...
                <td><?php echo e($appointment->preferred_date->format('m/d/Y')); ?></td>
            </tr>
        ...
        <div class="confirm-actions">
            <a href="<?php echo e(route('portal.track')); ?>?ref=<?php echo e($appointment->appointment_number); ?>" class="btn btn-primary">
