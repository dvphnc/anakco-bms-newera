    ...
    <div style="display:flex;flex-direction:column;gap:20px">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border)">
                    ...
                    <div style="font-size:13.5px;color:var(--text)"><?php echo e($household->address); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:12px;color:var(--text-muted)"><?php echo e($household->residents->count()); ?> member(s)</span>
            </div>
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div style="font-weight:600;font-size:13px"><?php echo e($resident->full_name); ?></div>
