...
<div class="page-header">
    ...
    <div class="page-actions">
        <a id="btnExportPdf" href="<?php echo e(route('export.pdf', 'documents')); ?>" class="btn btn-secondary" title="Export PDF">
            <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
        </a>
        <a id="btnExportExcel" href="<?php echo e(route('export.excel', 'documents')); ?>" class="btn btn-secondary" title="Export Excel">
...
<div class="no-print mb-4"
    ...
    <span>
        <strong><?php echo e($portalPending); ?></strong> portal request<?php echo e($portalPending > 1 ? 's' : ''); ?> pending release
    </span>
...
<div class="no-print" style="display:flex;align-items:center;gap:8px;margin-bottom:16px;flex-wrap:wrap">
    ...
    <button type="button" class="src-chip" data-src="portal"
        ...
        <span id="srcChipPortalCount" style="margin-left:5px;background:#1d4ed8;color:#fff;border-radius:4px;
            ...
            <?php echo e(\App\Models\Document::where('source','portal')->count()); ?>
...
$(document).ready(function () {
    ...
    var _pdfBase  = '<?php echo e(route('export.pdf',   'documents')); ?>';
    var _xlsxBase = '<?php echo e(route('export.excel', 'documents')); ?>';
