            ...
            <div style="margin-bottom:12px">
                ...
                <?php if($purok->leader): ?>
                    <div style="display:flex;align-items:center;gap:10px">
                        ...
                        <div>
                            <div style="font-weight:600;font-size:13.5px"><?php echo e($purok->leader->full_name); ?></div>
                ...
                <?php else: ?>
                    <div style="display:flex;align-items:center;gap:10px;padding:10px;background:var(--surface2);border-radius:var(--radius-sm);border:1px dashed var(--border)">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e(route('puroks.edit', $purok)); ?>" style="font-size:11px;color:var(--navy)">
                                Assign now →
                            </a>
                        </div>
                    </div>
