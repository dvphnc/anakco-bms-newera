...
<div class="wrap">
  ...
  <div class="hdr">
    ...
    <h1>
      <?php if($type === 'document'): ?> Document Request Update
      <?php elseif($type === 'blotter'): ?> Blotter Report Update
      <?php else: ?> Business Permit Request Update
      <?php endif; ?>
    </h1>
  </div>
  ...
  <div class="body">
    ...
    <div class="status-chip">
      <?php if($newStatus === 'Approved' || $newStatus === 'Resolved' || $newStatus === 'Released'): ?>
        ✅
      <?php elseif($newStatus === 'Cancelled' || $newStatus === 'Rejected' || $newStatus === 'Dismissed'): ?>
        ❌
      <?php else: ?>
        🔄
      <?php endif; ?>
    ...
    <div class="detail-box">
      <div class="detail-row">
        ...
        <span class="detail-value" style="font-family:monospace;color:#0D2144"><?php echo e($requestNumber); ?></span>
      </div>
      <div class="detail-row">
    ...
    <div class="note-box" style="background:#ecfdf5;border-color:#86efac;border-left-color:#2e6b47;">
      ...
      <?php if($preferredDate): ?> Your preferred pickup date is <strong><?php echo e(\Carbon\Carbon::parse($preferredDate)->format('F d, Y')); ?></strong>. <?php endif; ?>
    </div>
    <?php endif; ?>
    ...
    <p style="font-size:13px;color:#9ca3af;text-align:center;margin-top:12px">
      Reference: <strong style="color:#0D2144"><?php echo e($requestNumber); ?></strong>
    </p>
  </div>
