        ...
        <div class="card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0">
                ...
                <div style="padding:10px 0;border-bottom:1px solid var(--border);<?php echo e($loop->even ? 'padding-left:24px' : ''); ?>">
                    ...
                    <div style="font-size:13.5px;color:var(--text);font-weight:500"><?php echo e($d['value']); ?></div>
                </div>
            ...
            <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--border)">
                ...
                <div style="font-size:13.5px;color:var(--text)"><?php echo e($business->business_address); ?></div>
            </div>
            ...
            <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border)">
                ...
                <a href="<?php echo e(route('residents.show', $business->ownerResident)); ?>"
                   style="display:flex;align-items:center;gap:10px;color:var(--navy)">
                    ...
                    <div>
                        <div style="font-weight:600;font-size:13px"><?php echo e($business->ownerResident->full_name); ?></div>
