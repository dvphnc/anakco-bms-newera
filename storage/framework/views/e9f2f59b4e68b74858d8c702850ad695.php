...
<div class="report-sub">
    ...
    <?php if(!empty($filters['voter'])): ?> &nbsp;·&nbsp; Voter HH: <strong><?php echo e(ucfirst($filters['voter'])); ?></strong> <?php endif; ?>
    <?php if(!empty($filters['s'])): ?> &nbsp;·&nbsp; Search: <strong><?php echo e($filters['s']); ?></strong> <?php endif; ?>
</div>
...
<table>
    ...
    <tbody>
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="<?php echo e($i % 2 === 0 ? 'tr-odd' : 'tr-even'); ?>">
            <td style="text-align:center;color:#888"><?php echo e($i+1); ?></td>
            <td><strong><?php echo e($h->household_number); ?></strong></td>
            <td><?php echo e($h->household_head ?? '—'); ?></td>
            <td><?php echo e($h->purok->name ?? '—'); ?></td>
            <td><?php echo e($h->address); ?></td>
            <td style="text-align:center"><?php echo e($h->family_size ?? '—'); ?></td>
            <td style="text-align:center"><?php echo e($h->residents->count()); ?></td>
            <td><span class="badge <?php echo e($h->is_voter_household ? 'badge-green' : 'badge-gray'); ?>"><?php echo e($h->is_voter_household ? 'Yes' : 'No'); ?></span></td>
            <td><?php echo e($h->created_at->format('m/d/Y')); ?></td>
        </tr>
...
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views\exports\pdf\households.blade.php ENDPATH**/ ?>