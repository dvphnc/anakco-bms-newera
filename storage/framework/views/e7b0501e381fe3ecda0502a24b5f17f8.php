...
<div class="page-header">
    ...
    <div class="page-actions">
        <a id="btnExportPdf" href="<?php echo e(route('export.pdf', 'businesses')); ?>" class="btn btn-secondary" title="Export PDF">
            <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
        </a>
        <a id="btnExportExcel" href="<?php echo e(route('export.excel', 'businesses')); ?>" class="btn btn-secondary" title="Export Excel">
...
<?php $bizPortalPending = \App\Models\Business::where('source','portal')->where('status','Pending')->count(); ?>
<?php if($bizPortalPending > 0): ?>
<div class="no-print mb-4"
    ...
    <span>
        <strong><?php echo e($bizPortalPending); ?></strong> portal application<?php echo e($bizPortalPending > 1 ? 's' : ''); ?> pending issuance
    </span>
    <div style="display:flex;gap:8px;margin-left:auto;flex-shrink:0">
        ...
        <a href="<?php echo e(route('appointments.index')); ?>#business"
...
<div class="no-print" style="display:flex;align-items:center;gap:8px;margin-bottom:16px;flex-wrap:wrap">
    ...
    <button type="button" class="src-chip" data-src="portal"
        ...
        <span id="srcChipPortalCount" style="margin-left:5px;background:#1d4ed8;color:#fff;border-radius:4px;
            ...
            <?php echo e(\App\Models\Business::where('source','portal')->where('status','!=','Pending')->count()); ?>
...
$(document).ready(function () {
    ...
    var _pdfBase  = '<?php echo e(route('export.pdf',   'businesses')); ?>';
    var _xlsxBase = '<?php echo e(route('export.excel', 'businesses')); ?>';
