...
<head>
    ...
    <title>404 — Page Not Found | BMS</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-icon {
            ...
            margin:0 auto 28px;
            font-size:40px; color:#0D2144;
        }
        .error-code {
            font-size:80px; font-weight:800;
            color:#0D2144; line-height:1;
            letter-spacing:-4px; margin-bottom:12px;
        }
        .error-code span { color:#C8861A; }
        .error-title {
            font-size:22px; font-weight:700;
            color:#0D2144; margin-bottom:10px;
        }
        .error-msg {
...
<body>
    <div class="error-card">
        <div class="error-icon"><i class="fas fa-map-location-dot"></i></div>
...
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views/errors/404.blade.php ENDPATH**/ ?>