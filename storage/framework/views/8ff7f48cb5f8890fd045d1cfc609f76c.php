        ...
        <div class="filter-bar">
            ...
            <div class="form-group">
                ...
                <select id="officialPositionFilter">
                    <option value=""></option>
                    <?php $__currentLoopData = $officials->pluck('position')->unique()->sort()->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
