...
<div class="verify-wrap">
    ...
    <div class="verify-header">
        <img src="<?php echo e(asset('images/qc-seal.png')); ?>" alt="QC Seal" style="width:48px;height:48px;object-fit:contain;flex-shrink:0">
        <div class="verify-header-text" style="flex:1">
            <h1>Barangay New Era</h1>
            <p>Official Business Permit Verification</p>
            <span class="permit-num-badge"><?php echo e($permitNumber); ?></span>
        </div>
        <img src="<?php echo e(asset('images/bne-logo.png')); ?>" alt="BNE Logo" style="width:48px;height:48px;object-fit:contain;flex-shrink:0">
    </div>
    ...
    <div class="verify-card">
        ...
        <div class="not-found">
            ...
            <p>The permit number <strong><?php echo e($permitNumber); ?></strong> does not exist in our records. This document may be fraudulent.</p>
        </div>
        ...
        <div class="status-banner <?php echo e($bannerClass); ?>">
            <div class="status-icon"><i class="fas <?php echo e($icon); ?>"></i></div>
            <div class="status-text">
                <h2><?php echo e($statusText); ?></h2>
                <p><?php echo e($statusSub); ?></p>
            </div>
        </div>
        ...
        <img src="<?php echo e(asset('images/bne-logo.png')); ?>" class="verify-watermark" alt="">

        
        <div class="details">
            <div class="detail-row">
                <span class="detail-label">Permit No.</span>
                <span class="detail-value highlight"><?php echo e($business->permit_number); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Business Name</span>
                <span class="detail-value highlight"><?php echo e($business->business_name); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Business Type</span>
                <span class="detail-value"><?php echo e($business->business_type); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Owner</span>
                <span class="detail-value"><?php echo e($business->owner_name); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Address</span>
                <span class="detail-value"><?php echo e($business->business_address); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Date Issued</span>
                <span class="detail-value"><?php echo e($business->permit_date ? \Carbon\Carbon::parse($business->permit_date)->format('F d, Y') : '—'); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Valid Until</span>
                <span class="detail-value <?php echo e($isExpired ? 'expired-text' : 'valid-text'); ?>">
                    <?php echo e($expiry?->format('F d, Y') ?? '—'); ?>

                    <?php if($isValid): ?> &nbsp;<i class="fas fa-check-circle"></i> <?php endif; ?>
                    <?php if($isExpired): ?> &nbsp;<i class="fas fa-times-circle"></i> <?php endif; ?>
                </span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Status</span>
                <span class="detail-value <?php echo e($isValid ? 'valid-text' : 'expired-text'); ?>">
                    <?php echo e($business->status); ?>
        ...
        <div class="verify-footer">
            ...
            Verified on <?php echo e(now()->format('F d, Y \a\t h:i A')); ?><br>
...
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views/verify/business.blade.php ENDPATH**/ ?>