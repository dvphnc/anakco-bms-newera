...
<div class="page-header">
    ...
    <div class="page-actions">
        <a id="btnExportPdf" href="<?php echo e(route('export.pdf', 'households')); ?>" class="btn btn-secondary" title="Export PDF">
            <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
        </a>
        <a id="btnExportExcel" href="<?php echo e(route('export.excel', 'households')); ?>" class="btn btn-secondary" title="Export Excel">
...
<div class="grid-4 mb-6">
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number"><?php echo e(number_format(\App\Models\Purok::count())); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            ?>
            <div class="stat-number"><?php echo e($avg); ?></div>
...
$(document).ready(function () {
    var _pdfBase  = '<?php echo e(route('export.pdf',   'households')); ?>';
    var _xlsxBase = '<?php echo e(route('export.excel', 'households')); ?>';
    ...
    var table = $('#householdsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route('households.index')); ?>',
            data: function (d) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\anakco_bms\resources\views\households\households-index.blade.php ENDPATH**/ ?>