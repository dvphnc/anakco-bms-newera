...
<head>
    ...
    <title>403 — Access Denied | BMS</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-icon { width:96px; height:96px; background:rgba(155,28,28,0.07); border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 28px; font-size:40px; color:#9B1C1C; }
        .error-code { font-size:80px; font-weight:800; color:#0D2144; line-height:1; letter-spacing:-4px; margin-bottom:12px; }
        .error-code span { color:#9B1C1C; }
...
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views\errors\403.blade.php ENDPATH**/ ?>