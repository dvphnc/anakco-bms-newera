...
<div class="page-header">
    ...
    <div class="page-actions">
        <a id="btnExportPdf" href="<?php echo e(route('export.pdf', 'residents')); ?>" class="btn btn-secondary" title="Export PDF">
            <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
        </a>
        <a id="btnExportExcel" href="<?php echo e(route('export.excel', 'residents')); ?>" class="btn btn-secondary" title="Export Excel">
...
$(document).ready(function () {
    ...
    var _pdfBase  = '<?php echo e(route('export.pdf',   'residents')); ?>';
    var _xlsxBase = '<?php echo e(route('export.excel', 'residents')); ?>';
