...
<div class="no-print" style="display:flex;align-items:center;gap:12px;background:var(--navy);border-radius:var(--radius);padding:12px 18px;margin-bottom:20px">
    ...
    <div style="flex:1;min-width:0">
        ...
        <div id="caseRefNum" style="font-size:17px;font-weight:700;color:#fff;font-family:'Courier New',monospace;letter-spacing:0.05em"><?php echo e($blotter->case_number); ?></div>
    </div>
...
<div class="no-print" style="display:grid;grid-template-columns:280px 1fr;gap:20px;align-items:start">
                ...
                <div style="display:flex;flex-direction:column;gap:10px">
                    <div>
                        ...
                        <div style="font-size:15px;font-weight:500;color:var(--text)">
                            <?php echo e($blotter->incident_date ? \Carbon\Carbon::parse($blotter->incident_date)->format('m/d/Y') : '—'); ?>
                    ...
                    <div>
                        ...
                        <div style="font-size:15px;color:var(--text-muted)"><?php echo e($blotter->settled_at->format('m/d/Y')); ?></div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div style="display:flex;flex-direction:column;gap:20px">
        ...
        <?php if($blotter->responding_officer): ?>
        <div class="card">
            <div class="card-header">
            ...
            <div class="card-body">
                <div style="display:flex;align-items:center;gap:10px">
                    ...
                    <div>
                        <div style="font-weight:600;font-size:14px"><?php echo e($blotter->responding_officer); ?></div>
...
<div class="rpt-border">
    ...
    <div class="rpt-grid">
        ...
        <div class="rpt-field">
            ...
            <span class="val"><?php echo e($blotter->incident_date ? \Carbon\Carbon::parse($blotter->incident_date)->format('m/d/Y') : '—'); ?></span>
        </div>
        <div class="rpt-field">
        ...
        <div class="rpt-field">
            ...
            <span class="val"><?php echo e($blotter->created_at->format('m/d/Y')); ?></span>
        </div>
        <div class="rpt-field">
    ...
    <div class="rpt-fullwidth">
        ...
        <div class="val"><?php echo e($blotter->incident_location ?? '—'); ?></div>
    </div>
    ...
    <div class="rpt-fullwidth">
        <span class="val"><?php echo e($blotter->responding_officer); ?></span>
    </div>
    <?php endif; ?>
    ...
    <div class="rpt-grid">
        ...
        <div class="rpt-field" style="border-bottom:none">
            ...
            <span class="val"><?php echo e($blotter->settled_at->format('m/d/Y')); ?></span>
        </div>
        <div class="rpt-field" style="border-bottom:none">
    ...
    <div class="rpt-fullwidth">
        ...
        <div class="val"><?php echo e($blotter->resolution_notes); ?></div>
    </div>
    <?php endif; ?>
    <?php endif; ?>
    ...
    <div class="rpt-sig-section">
        ...
        <div class="rpt-footer">
            <span>Printed by: <?php echo e(auth()->user()->name); ?> — <?php echo e(now()->format('m/d/Y g:i A')); ?></span>
