            ...
            <div style="padding:14px 20px;border-top:1px solid var(--border)">
                <div style="display:flex;flex-direction:column;gap:10px">
                    ...
                    <div>
                        ...
                        <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->incident_location ?? '—'); ?></div>
                    </div>
                    <div>
                        ...
                        <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->filedBy->name ?? '—'); ?></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->settled_at->format('F d, Y')); ?></div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div style="display:flex;align-items:center;gap:10px;<?php echo e($isImage ? 'margin-top:10px' : ''); ?>">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--text-muted)"><?php echo e(strtoupper($blotter->file_type ?? '')); ?></div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('residents.show', $blotter->complainantResident)); ?>"
                       style="display:flex;align-items:center;gap:10px;margin-bottom:14px;color:var(--navy)">
                        ...
                        <div>
                            <div style="font-weight:600;font-size:13px"><?php echo e($blotter->complainantResident->full_name); ?></div>
                    ...
                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px">
                        ...
                        <div>
                            <div style="font-weight:600;font-size:13px"><?php echo e($blotter->complainant_name ?? '—'); ?></div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px">
                        ...
                        <div>
                            ...
                            <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->complainant_address); ?></div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->complainant_contact); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px">
                        ...
                        <div>
                            <div style="font-weight:600;font-size:13px"><?php echo e($blotter->respondent_name ?? '—'); ?></div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px">
                        ...
                        <div>
                            <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle)">Address</div>
                            <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->respondent_address); ?></div>
                        </div>
                        <?php endif; ?>
                        <?php if($blotter->respondent_contact): ?>
                        <div>
                            <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle)">Contact</div>
                            <div style="font-size:13px;color:var(--text-muted)"><?php echo e($blotter->respondent_contact); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
