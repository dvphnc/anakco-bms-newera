...
<head>
    ...
    <title>500 — Server Error | BMS</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-icon { width:96px; height:96px; background:rgba(200,134,26,0.1); border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 28px; font-size:40px; color:#C8861A; }
        ...
        .btn { display:inline-flex; align-items:center; gap:8px; padding:10px 24px; border-radius:8px; font-size:13px; font-weight:600; text-decoration:none; transition:all 0.15s; font-family:'Poppins',sans-serif; }
...
<body>
    <div class="error-card">
        ...
        <div>
            <a href="<?php echo e(url('/')); ?>" class="btn btn-primary"><i class="fas fa-house"></i> Go to Dashboard</a>
            <a href="javascript:location.reload()" class="btn btn-secondary"><i class="fas fa-rotate-right"></i> Try Again</a>
        </div>
        <div class="barangay-label">BARANGAY NEW ERA MANAGEMENT SYSTEM</div>
    </div>
</body>
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views/errors/500.blade.php ENDPATH**/ ?>