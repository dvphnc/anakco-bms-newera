    ...
    <div id="left-col" style="display:flex;flex-direction:column;gap:16px;min-width:0;width:100%">
                    ...
                    <div class="form-group" style="margin-bottom:20px">
                        ...
                        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px">
                            ...
                            <label style="display:flex;flex-direction:column;align-items:center;gap:6px;padding:14px 6px;border:1.5px solid var(--border);border-radius:var(--radius);cursor:pointer;transition:all 0.15s;text-align:center;background:var(--surface);min-width:0;flex:1"
                                ...
                                <span style="font-size:11.5px;font-weight:700;color:var(--text)"><?php echo e($lbl); ?></span>
                                <span style="font-size:10px;color:var(--text-muted)"><?php echo e($sub); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="card-body" style="padding:10px 12px;display:flex;flex-direction:column;gap:5px">
                ...
                <form method="POST" action="<?php echo e(route('reports.generate')); ?>">
                    ...
                    <button type="submit" class="btn btn-secondary" style="width:100%;justify-content:flex-start;padding:8px 12px;font-size:12px;gap:8px">
                        ...
                        <span style="flex:1;text-align:left"><?php echo e($q['label']); ?></span>
                    </button>
                </form>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="card" id="snapshot-card" style="width:100%">
            <div class="card-header">
                ...
                <span style="font-size:11px;color:var(--text-muted)"><?php echo e(now()->format('M d, Y')); ?></span>
            </div>
            <div class="card-body" style="padding:10px 16px">
                ...
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:14px">
                    ...
                    <div style="text-align:center;padding:8px 6px;background:<?php echo e($t['bg']); ?>;border-radius:var(--radius-sm)">
                        ...
                        <div style="font-size:10px;color:var(--text-muted)"><?php echo e($t['label']); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle);margin-bottom:8px">This Month — <?php echo e(now()->format('F')); ?></div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px 32px;flex:1;align-content:space-between">
                    ...
                    <div>
                        <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                            ...
                            <span style="font-size:12.5px;font-weight:700;color:var(--text)"><?php echo e(number_format($d['value'])); ?></span>
                        </div>
            ...
            <div class="card-body" style="padding:12px 16px;flex:1;display:flex;flex-direction:column">
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px;flex:1">
                    ...
                    <div style="background:<?php echo e($c['bg']); ?>;border:1px solid <?php echo e($c['border']); ?>;border-radius:var(--radius-sm);padding:12px;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center">
                        ...
                        <div style="display:inline-block;background:<?php echo e($c['badge']); ?>;color:<?php echo e($c['text']); ?>;font-size:10px;font-weight:700;padding:1px 7px;border-radius:99px;margin:3px 0"><?php echo e($pct); ?>%</div>
                        <div style="font-size:11px;font-weight:600;color:<?php echo e($c['text']); ?>;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%"><?php echo e($purok->name); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
