    ...
    <div class="hero-inner">
        ...
        <div class="hero-content">
            ...
            <div class="hero-ctas">
                ...
                <a href="<?php echo e(route('portal.about')); ?>" class="btn btn-outline btn-lg">
                    <i class="fas fa-landmark"></i> About the Barangay
                </a>
            </div>
            <div class="hero-pills">
                <span class="hero-pills-label">Services:</span>
                <a href="<?php echo e(route('portal.request')); ?>?type=Barangay+Clearance" class="hero-pill"><i class="fas fa-file-shield"></i> Clearance</a>
                <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Indigency" class="hero-pill"><i class="fas fa-hand-holding-heart"></i> Indigency</a>
                <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Residency" class="hero-pill"><i class="fas fa-house-circle-check"></i> Residency</a>
                <a href="<?php echo e(route('portal.blotter')); ?>" class="hero-pill"><i class="fas fa-gavel"></i> Blotter</a>
                <a href="<?php echo e(route('portal.business')); ?>" class="hero-pill"><i class="fas fa-store"></i> Business</a>
            </div>
        </div>
        ...
        <div class="track-panel" role="complementary" aria-label="Track your appointment">
            ...
            <form class="track-form" action="<?php echo e(route('portal.track.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="track-shortcuts">
                <a href="<?php echo e(route('portal.request')); ?>" class="track-shortcut">
                ...
                <a href="<?php echo e(route('portal.blotter')); ?>" class="track-shortcut">
                ...
                <a href="<?php echo e(route('portal.business')); ?>" class="track-shortcut">
...
<section class="page-section" id="services" style="background:#f7f8fa;">
    <div class="page-section-inner">
        ...
        <div class="svc-grid">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Barangay+Clearance" class="svc-tile svc-navy">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Indigency" class="svc-tile svc-gold">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Residency" class="svc-tile svc-green">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Business+Clearance" class="svc-tile svc-blue">
            ...
            <a href="<?php echo e(route('portal.blotter')); ?>" class="svc-tile svc-red">
            ...
            <a href="<?php echo e(route('portal.business')); ?>" class="svc-tile svc-teal">
