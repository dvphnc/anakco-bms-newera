...
<section class="sec services-sec" id="services">
    <div class="sec-inner">
        ...
        <div class="svc-grid">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Barangay+Clearance" class="svc-card sc-navy">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Indigency" class="svc-card sc-gold">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Residency" class="svc-card sc-green">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Business+Clearance" class="svc-card sc-blue">
            ...
            <a href="<?php echo e(route('portal.blotter')); ?>" class="svc-card sc-red">
            ...
            <a href="<?php echo e(route('portal.business')); ?>" class="svc-card sc-teal">
