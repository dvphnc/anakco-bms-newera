    ...
    <div class="hero-inner">
        ...
        <div class="h-panel h-panel-anim">
            ...
            <div class="h-services">
                <a href="<?php echo e(route('portal.request')); ?>" class="h-svc">
                ...
                <a href="<?php echo e(route('portal.blotter')); ?>" class="h-svc">
                ...
                <a href="<?php echo e(route('portal.business')); ?>" class="h-svc">
...
<section class="sec services-sec" id="services">
    <div class="sec-inner">
        ...
        <div class="svc-grid">
            <a href="<?php echo e(route('portal.request')); ?>?type=Barangay+Clearance" class="svc-card sc-navy" data-ao="fade-up" data-ao-delay="1">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Indigency" class="svc-card sc-gold" data-ao="fade-up" data-ao-delay="2">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Certificate+of+Residency" class="svc-card sc-green" data-ao="fade-up" data-ao-delay="3">
            ...
            <a href="<?php echo e(route('portal.request')); ?>?type=Business+Clearance" class="svc-card sc-blue" data-ao="fade-up" data-ao-delay="1">
            ...
            <a href="<?php echo e(route('portal.blotter')); ?>" class="svc-card sc-red" data-ao="fade-up" data-ao-delay="2">
            ...
            <a href="<?php echo e(route('portal.business')); ?>" class="svc-card sc-teal" data-ao="fade-up" data-ao-delay="3">
