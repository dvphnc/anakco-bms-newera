    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="card">
            <div style="background:linear-gradient(135deg,var(--navy),var(--navy-mid));padding:28px 20px;text-align:center">
                ...
                <div style="font-size:13px;color:rgba(229,160,32,0.85);font-weight:500;margin-bottom:10px"><?php echo e($official->position); ?></div>
            ...
            <div style="padding:14px 16px;border-top:1px solid var(--border)">
                ...
                <div style="font-size:13px;color:var(--text-subtle);margin-top:5px;text-align:center"><?php echo e($tPct); ?>% of term served</div>
            </div>
            <?php endif; ?>
        </div>
        <div class="card">
            ...
            <div class="card-body" style="display:flex;flex-direction:column;gap:8px">
                ...
                <form method="POST" action="<?php echo e(route('officials.destroy', $official)); ?>"
                      data-confirm="Delete <?php echo e($official->full_name); ?>? This will remove their profile and ID card."
