<?php $__env->startSection('title', $official->full_name); ?>
...
<div class="page-header no-print">
    ...
    <div class="page-actions">
        ...
        <a href="<?php echo e(route('officials.edit', $official)); ?>" class="btn btn-secondary">
        ...
        <div class="card">
            <div style="background:linear-gradient(135deg,var(--navy),var(--navy-mid));padding:28px 20px;text-align:center">
                <div style="width:90px;height:90px;border-radius:50%;overflow:hidden;margin:0 auto 16px;border:3px solid rgba(200,134,26,0.45)">
                    <?php if($official->photo_path): ?>
                        <img src="<?php echo e(asset('storage/'.$official->photo_path)); ?>" style="width:100%;height:100%;object-fit:cover">
                    <?php else: ?>
                        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--gold),var(--gold-light));font-size:32px;font-weight:800;color:var(--navy)">
                            <?php echo e(strtoupper(substr($official->full_name, 0, 1))); ?>

                        </div>
                    <?php endif; ?>
                </div>
                <div style="font-size:17px;font-weight:700;color:#fff;margin-bottom:6px"><?php echo e($official->full_name); ?></div>
                <div style="font-size:12px;color:rgba(229,160,32,0.85);font-weight:500;margin-bottom:10px"><?php echo e($official->position); ?></div>
                <span class="badge <?php echo e($official->is_active ? 'badge-green' : 'badge-gray'); ?>"><?php echo e($official->is_active ? 'Active' : 'Inactive'); ?></span>
            </div>
            <?php if($official->term_start && $official->term_end): ?>
            <?php
            ...
            <div style="padding:14px 16px;border-top:1px solid var(--border)">
                <div style="display:flex;justify-content:space-between;font-size:10px;color:var(--text-subtle);margin-bottom:6px">
                    <span><?php echo e($tStart->format('Y')); ?></span><span><?php echo e($tEnd->format('Y')); ?></span>
                </div>
                <div class="progress-bar-wrap"><div class="progress-bar" style="width:<?php echo e($tPct); ?>%;background:var(--gold)"></div></div>
                <div style="font-size:10px;color:var(--text-subtle);margin-top:5px;text-align:center"><?php echo e($tPct); ?>% of term served</div>
            </div>
            <?php endif; ?>
        </div>
        <div class="card">
            ...
            <div class="card-body" style="display:flex;flex-direction:column;gap:8px">
                ...
                <a href="<?php echo e(route('officials.edit', $official)); ?>" class="btn btn-secondary" style="justify-content:flex-start">
                    <i class="fas fa-pen" style="color:var(--navy)"></i> Edit Profile
                </a>
                <form method="POST" action="<?php echo e(route('officials.destroy', $official)); ?>" onsubmit="return confirm('Delete this official?')">
        ...
        <div class="card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0">
                ...
                <div style="padding:10px 0;border-bottom:1px solid var(--border);<?php echo e($loop->even ? 'padding-left:24px' : ''); ?>">
                    <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-subtle);margin-bottom:2px"><?php echo e($d['label']); ?></div>
...
<div class="idc">
    ...
    <div class="idc-header">
        <img src="<?php echo e(asset('images/qc-seal.png')); ?>" alt="QC">
        ...
        <img src="<?php echo e(asset('images/bne-logo.png')); ?>" alt="BNE">
    </div>
    ...
    <div class="idc-idnum"><?php echo e($idNumber); ?></div>

    
    <div class="idc-middle">
        <img src="<?php echo e(asset('images/bne-logo.png')); ?>" class="idc-wm" alt=""
        ...
        <div class="idc-photo">
            <?php if($official->photo_path): ?>
                <img src="<?php echo e(asset('storage/'.$official->photo_path)); ?>" alt="Photo">
            <?php else: ?>
                <?php echo e(strtoupper(substr($official->full_name, 0, 1))); ?>
        ...
        <div style="display:flex;flex-direction:row;align-items:center;position:relative;z-index:1;">
            <svg width="22" height="<?php echo e($bcHeight); ?>" xmlns="http://www.w3.org/2000/svg"
                 style="display:block;max-height:1.05in;">
                <rect x="0" y="0" width="22" height="<?php echo e($bcHeight); ?>" fill="#fff"/>
                <?php echo $svgBars; ?>

            </svg>
            <div style="font-family:'Courier New',monospace;font-size:3.8pt;color:#0D2144;writing-mode:vertical-rl;transform:rotate(180deg);letter-spacing:0.06em;font-weight:800;margin-left:3px;padding:2px 0;"><?php echo e($idNumber); ?></div>
        </div>
    </div>
    ...
    <div class="idc-name">
        ...
        <div class="idc-nm"><?php echo e($official->full_name); ?></div>
    </div>
    ...
    <div class="idc-details">
        <div class="idc-det">
            ...
            <span class="idc-det-val"><?php echo e($termShort); ?></span>
        </div>
        <?php if($official->committee): ?>
        <div class="idc-det">
            <span class="idc-det-lbl">Committee</span>
            <span class="idc-det-val" style="font-size:5pt"><?php echo e($official->committee); ?></span>
        </div>
        <?php endif; ?>
        <?php if($official->contact_number): ?>
        <div class="idc-det">
            <span class="idc-det-lbl">Contact</span>
            <span class="idc-det-val"><?php echo e($official->contact_number); ?></span>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="idc-pos">
        <div class="idc-pos-txt"><?php echo e($official->position); ?></div>
    ...
    <div class="idc-footer">
        <div>
            ...
            <span class="idc-foot-val"><?php echo e($validUntil); ?></span>
        </div>
        <div style="text-align:right">
            <span class="idc-foot-lbl">Status</span>
            <span class="idc-foot-val" style="color:<?php echo e($official->is_active ? '#6EE7A0' : 'rgba(255,255,255,0.4)'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\anakco_bms\resources\views/officials/officials-show.blade.php ENDPATH**/ ?>