...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-grid-2 mb-6">
            <div class="form-group">
                ...
                <input type="text" name="purpose" class="form-control" value="<?php echo e(old('purpose', $document->purpose)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" name="fee_paid" class="form-control" value="<?php echo e(old('fee_paid', $document->fee_paid ?? 0)); ?>" min="0" step="0.01">
            </div>
            <div class="form-group">
                <label class="form-label">OR Number</label>
                <input type="text" name="or_number" class="form-control" placeholder="e.g. OR-2026-00001" value="<?php echo e(old('or_number', $document->or_number)); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Date Released</label>
                <input type="date" name="released_at" class="form-control" value="<?php echo e(old('released_at', $document->released_at?->format('Y-m-d'))); ?>">
            </div>
        </div>
