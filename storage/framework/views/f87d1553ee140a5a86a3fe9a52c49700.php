...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="<?php echo e(route('export.pdf', 'households')); ?>" class="btn btn-secondary" title="Export PDF">
    <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
</a>
<a href="<?php echo e(route('export.excel', 'households')); ?>" class="btn btn-secondary" title="Export Excel">
