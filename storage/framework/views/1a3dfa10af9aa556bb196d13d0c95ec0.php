<?php $__env->startSection('title', 'Business Permit Request'); ?>
...
<div class="p-card">
    ...
    <div class="page-hd">
        <h2><i class="fas fa-store" style="color:var(--gold)"></i>&nbsp; Business Permit Request</h2>
        <p>Submit your business permit application online. All fields marked with <span style="color:var(--crimson)">*</span> are required.</p>
    </div>
    ...
    <form id="businessForm" novalidate>
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="operation_year">Year Started Operations <span style="color:#9ca3af;font-weight:400">(optional)</span></label>
                <input type="number" id="operation_year" name="operation_year" class="form-control"
                       placeholder="<?php echo e(date('Y')); ?>" min="1900" max="<?php echo e(date('Y') + 1); ?>">
                <div class="form-error" id="err-operation_year" style="display:none"></div>
            </div>
            <div class="form-group">
        ...
        <p class="disclaimer">
            ...
            A barangay inspector may visit the business premises as part of the evaluation process.
        </p>
    </form>
...
(function () {
    ...
    document.getElementById('businessForm').addEventListener('submit', function (e) {
        ...
        axios.post('<?php echo e(route('portal.business.store')); ?>', fd, {
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\anakco_bms\resources\views/portal/business-request.blade.php ENDPATH**/ ?>