...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-top:24px;padding-top:16px;border-top:1px solid var(--border);display:flex;gap:24px;flex-wrap:wrap">
            ...
            <div>
                ...
                <div style="font-size:14px;color:var(--text);margin-top:2px"><?php echo e($user->created_at->format('m/d/Y')); ?></div>
            </div>
            <div>
                ...
                <div style="font-size:14px;color:var(--text);margin-top:2px"><?php echo e($user->updated_at->format('m/d/Y')); ?></div>
            </div>
        </div>
