...
<div class="card">
    <div class="card-header">
        ...
        <span style="font-size:13px;color:var(--text-muted)"><?php echo e(number_format($users->total())); ?> users</span>
    </div>
                    ...
                    <td>
                        <div style="display:flex;justify-content:flex-end;gap:6px">
                            ...
                            <form method="POST" action="<?php echo e(route('users.destroy', $user)); ?>"
                                  data-confirm="Delete <?php echo e($user->name); ?>? This will permanently remove their account."
