            ...
            <div>
                ...
                <div style="font-size:13px;color:var(--text);margin-top:6px;display:flex;align-items:center;gap:8px">
                    <?php if($user->email_verified_at): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('users.unverify', $user)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-secondary btn-sm"
                                    onclick="return confirm('Remove verification from <?php echo e($user->name); ?>?')"
                    ...
                    <?php else: ?>
                        ...
                        <?php if(auth()->user()->role === 'Admin'): ?>
                        <form method="POST" action="<?php echo e(route('users.verify', $user)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
