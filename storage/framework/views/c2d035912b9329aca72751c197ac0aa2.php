...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-top:24px;padding-top:16px;border-top:1px solid var(--border);display:flex;gap:24px;flex-wrap:wrap">
            <div>
                ...
                <div style="font-size:13px;color:var(--text);margin-top:6px;display:flex;align-items:center;gap:8px">
                    <?php if($user->email_verified_at): ?>
                        ...
                        <span style="font-size:13px;color:var(--text-subtle)"><?php echo e($user->email_verified_at->format('M d, Y')); ?></span>
            ...
            <div>
                ...
                <div style="font-size:14px;color:var(--text);margin-top:2px"><?php echo e($user->created_at->format('F d, Y')); ?></div>
            </div>
            <div>
                ...
                <div style="font-size:14px;color:var(--text);margin-top:2px"><?php echo e($user->updated_at->format('F d, Y')); ?></div>
            </div>
        </div>
...
<form method="POST" action="<?php echo e(route('users.destroy', $user)); ?>" id="delete-user-form"
      data-confirm="Permanently delete <?php echo e($user->name); ?>? This cannot be undone."
...
<form method="POST" action="<?php echo e(route('users.unverify', $user)); ?>" id="unverify-form"
      data-confirm="Remove email verification for <?php echo e($user->name); ?>?"
