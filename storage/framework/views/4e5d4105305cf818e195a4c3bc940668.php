...
<div class="page-header">
    ...
    <div class="page-actions">
        <a id="btnExportPdf" href="<?php echo e(route('export.pdf', 'blotter')); ?>" class="btn btn-secondary" title="Export PDF">
            <i class="fas fa-file-pdf" style="color:#dc2626"></i> PDF
        </a>
        <a id="btnExportExcel" href="<?php echo e(route('export.excel', 'blotter')); ?>" class="btn btn-secondary" title="Export Excel">
...
<div class="grid-4 mb-6">
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number" id="statBlotTotal"><?php echo e(number_format(\App\Models\BlotterCase::count())); ?></div>
...
<?php $blotterPortalPending = \App\Models\BlotterCase::where('source','portal')->where('status','Pending')->count(); ?>
<?php if($blotterPortalPending > 0): ?>
<div class="no-print mb-4"
    ...
    <span>
        <strong><?php echo e($blotterPortalPending); ?></strong> portal report<?php echo e($blotterPortalPending > 1 ? 's' : ''); ?> pending activation
    </span>
    <div style="display:flex;gap:8px;margin-left:auto;flex-shrink:0">
        ...
        <a href="<?php echo e(route('appointments.index')); ?>#blotter"
...
$(document).ready(function () {
    ...
    var _pdfBase  = '<?php echo e(route('export.pdf',   'blotter')); ?>';
    var _xlsxBase = '<?php echo e(route('export.excel', 'blotter')); ?>';
