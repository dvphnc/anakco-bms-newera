...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('business_name')); ?>" placeholder="e.g. Juan's Sari-Sari Store" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('business_address')); ?>" placeholder="Full address of business location" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('owner_name')); ?>" placeholder="Full name" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="owner_contact" id="owner_contact" class="form-control <?php $__errorArgs = ['owner_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('owner_contact')); ?>" placeholder="09XX XXX XXXX">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-grid-3 mb-6">
            <div class="form-group">
                ...
                <input type="date" name="permit_date" class="form-control <?php $__errorArgs = ['permit_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('permit_date', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('expiry_date', date('Y-m-d', strtotime('+1 year')))); ?>" required>
