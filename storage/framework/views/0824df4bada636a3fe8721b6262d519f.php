...
<div class="report-sub">
    ...
    <?php if(!empty($filters['business_type'])): ?> &nbsp;·&nbsp; Type: <strong><?php echo e($filters['business_type']); ?></strong> <?php endif; ?>
    <?php if(!empty($filters['source'])): ?> &nbsp;·&nbsp; Source: <strong><?php echo e(ucfirst($filters['source'])); ?></strong> <?php endif; ?>
    <?php if(!empty($filters['expiry_filter'])): ?> &nbsp;·&nbsp; Expiry: <strong><?php echo e(ucwords(str_replace('_', ' ', $filters['expiry_filter']))); ?></strong> <?php endif; ?>
</div>
...
<table>
    ...
    <tbody>
        ...
        ?>
        <tr class="<?php echo e($rowCls ?: ($i % 2 === 0 ? 'tr-odd' : 'tr-even')); ?>">
            <td style="text-align:center;color:#888"><?php echo e($i+1); ?></td>
            <td><strong><?php echo e($b->permit_number); ?></strong></td>
            <td><?php echo e($b->business_name); ?></td>
            <td><?php echo e($b->business_type); ?></td>
            <td><?php echo e($b->owner_name); ?></td>
            <td><?php echo e($b->owner_contact ?? '—'); ?></td>
            <td><?php echo e($b->business_address); ?></td>
            <td><?php echo e($b->permit_date ? \Carbon\Carbon::parse($b->permit_date)->format('m/d/Y') : '—'); ?></td>
            <td><?php echo e($b->expiry_date ? \Carbon\Carbon::parse($b->expiry_date)->format('m/d/Y') : '—'); ?></td>
...
</html><?php /**PATH D:\laragon\www\anakco_bms\resources\views/exports/pdf/businesses.blade.php ENDPATH**/ ?>