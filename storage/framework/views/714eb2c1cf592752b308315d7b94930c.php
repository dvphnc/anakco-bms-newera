...
<div id="dpanel-overview" class="dash-panel active">
    ...
    <div class="dash-stats" id="tour-statcards">
        <a href="<?php echo e(route('residents.index')); ?>" class="dash-stat-card" style="--stat-accent:#4f46e5">
        ...
        <a href="<?php echo e(route('documents.index')); ?>" class="dash-stat-card" style="--stat-accent:#d97706">
        ...
        <a href="<?php echo e(route('blotter.index')); ?>" class="dash-stat-card" style="--stat-accent:#dc2626">
        ...
        <a href="<?php echo e(route('businesses.index')); ?>" class="dash-stat-card" style="--stat-accent:#16a34a">
        ...
        <?php if(in_array(auth()->user()->role, ['Admin','Secretary'])): ?>
        <a href="<?php echo e(route('appointments.index')); ?>" class="dash-stat-card" style="--stat-accent:var(--gold)">
