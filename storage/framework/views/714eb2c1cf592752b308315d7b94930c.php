        ...
        <div>
            ...
            <div style="font-size:14px;font-weight:700;color:var(--navy);display:flex;align-items:center;gap:7px">
                <span style="width:7px;height:7px;border-radius:50%;
                             background:<?php echo e($backupOk ? '#22c55e' : 'var(--gold)'); ?>;
                             display:inline-block;
                             box-shadow:0 0 0 3px <?php echo e($backupOk ? 'rgba(34,197,94,0.18)' : 'rgba(200,134,26,0.18)'); ?>"></span>
        ...
        <a href="<?php echo e(route('blotter.index')); ?>" class="dash-stat-card">
            ...
            <div>
                ...
                <div style="font-size:12px;color:var(--crimson);margin-top:4px;font-weight:600;
                    ...
                    <?php echo e($overdueBlotter); ?> overdue 30+ days
                </div>
                <?php endif; ?>
            </div>
        </a>
