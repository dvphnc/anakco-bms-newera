                ...
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:8px">
                            ...
                            <div>
                                <div style="font-size:12.5px;font-weight:600;font-family:monospace;color:var(--text)"><?php echo e($file['name']); ?></div>
                                <?php if($i === 0): ?><span class="badge badge-green" style="font-size:9px">Latest</span><?php endif; ?>
                            </div>
                        </div>
                    </td>
                    <td style="font-size:12px;color:var(--text-muted)"><?php echo e($file['size']); ?></td>
                    <td style="font-size:12px;color:var(--text-muted)"><?php echo e($file['created']); ?></td>
                    <td>
                        <div style="display:flex;gap:6px">
                            ...
                            <form method="POST" action="<?php echo e(route('backup.restore')); ?>"
                                  onsubmit="return confirm('⚠️ Restore from <?php echo e($file['name']); ?>? This will overwrite all current data!')">
                                <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div style="display:flex;flex-direction:column;gap:10px">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;padding:8px;background:var(--surface2);border-radius:var(--radius-sm);border:1px solid var(--border)">
                        ...
                        <div>
                            <div style="font-size:10px;color:var(--text-subtle);text-transform:uppercase;letter-spacing:0.06em"><?php echo e($item['label']); ?></div>
                            <div style="font-size:12px;font-weight:600;color:var(--text);font-family:monospace"><?php echo e($item['value']); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
