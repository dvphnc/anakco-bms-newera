        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:12px">
            ...
            <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden">
                ...
                <div style="background:<?php echo e($m['color']); ?>12;padding:14px 16px;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:10px">
                    ...
                    <div>
                        <div style="font-size:13px;font-weight:700;color:var(--text)"><?php echo e($m['label']); ?></div>
            ...
            <div style="margin-top:20px;padding-top:16px;border-top:1px solid var(--border)">
                ...
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px">
                    ...
                    <div style="text-align:center;padding:10px;background:var(--surface2);border-radius:var(--radius-sm);border:1px solid var(--border)">
                        ...
                        <div style="font-size:10.5px;color:var(--text-muted);margin-top:2px"><?php echo e($s['label']); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<div class="grid-3 mb-6">
        ...
        <div class="card-body" style="padding:0">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size:12.5px"><?php echo e($type); ?></td>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div style="margin-bottom:14px">
                <div style="display:flex;justify-content:space-between;margin-bottom:5px">
                    <span style="font-size:12.5px;color:var(--text)"><?php echo e($b['label']); ?></span>
                    <span style="font-size:12px;color:var(--text-muted)"><?php echo e(number_format($b['value'])); ?> (<?php echo e($pct); ?>%)</span>
                </div>
                <div class="progress-bar-wrap">
