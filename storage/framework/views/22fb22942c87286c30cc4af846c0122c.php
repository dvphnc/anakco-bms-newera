                ...
                <div class="field-group">
                    ...
                    <div class="field-wrapper">
                        ...
                        <input type="email" id="email" name="email"
                               class="field-input <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="field-error"><i class="fas fa-circle-exclamation"></i> <?php echo e($message); ?></div>
                    <?php unset($message);
                ...
                <div class="field-group">
                    ...
                    <div class="field-wrapper">
                        ...
                        <input type="password" id="password" name="password"
                               class="field-input <?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>"
                               placeholder="••••••••"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="right-footer">
            &copy; <?php echo e(date('Y')); ?> Barangay New Era, District VI, Quezon City
        </div>
    </div>
