        ...
        <div class="card">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;border-top:1px solid var(--border)">
                <div style="padding:14px 16px;text-align:center;border-right:1px solid var(--border)">
                    <div style="font-size:20px;font-weight:700;color:var(--navy)"><?php echo e($resident->age ?? '—'); ?></div>
                    <div style="font-size:11px;color:var(--text-muted)">Age</div>
                </div>
                <div style="padding:14px 16px;text-align:center">
                    <div style="font-size:20px;font-weight:700;color:var(--navy)"><?php echo e($resident->years_of_residency ?? '—'); ?></div>
            ...
            <div class="card-body">
                ...
                <div class="tab-pane active" id="tab-personal">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:0">
                        ...
                        <div style="padding:10px 0;border-bottom:1px solid var(--border);<?php echo e($loop->iteration % 2 === 0 ? 'padding-left:24px' : ''); ?>">
                ...
                <div class="tab-pane" id="tab-documents">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 0;border-bottom:1px solid var(--border)">
                        <div>
                            ...
                            <div style="font-weight:600;font-size:13px"><?php echo e($doc->document_type); ?></div>
                            <div class="td-muted"><?php echo e($doc->created_at->format('M d, Y')); ?></div>
                        </div>
                ...
                <div class="tab-pane" id="tab-blotter">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 0;border-bottom:1px solid var(--border)">
                        <div>
                            ...
                            <div style="font-weight:600;font-size:13px"><?php echo e($case->incident_type); ?></div>
                            <div class="td-muted"><?php echo e($case->incident_date?->format('M d, Y')); ?></div>
                        </div>
                        <div style="display:flex;align-items:center;gap:10px">
