...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="<?php echo e(route('households.show', $household)); ?>" class="btn btn-secondary"><i class="fas fa-eye"></i> View</a>
    ...
    <div class="card-body">
        ...
        <div class="form-grid-2 mb-6">
            <div class="form-group">
                ...
                <input type="text" name="household_head" id="household_head" class="form-control" value="<?php echo e(old('household_head', $household->household_head)); ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="purok_id" id="s2Purok" class="form-control" required>
                    ...
                    <?php $__currentLoopData = $puroks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($purok->id); ?>" <?php echo e(old('purok_id', $household->purok_id) == $purok->id ? 'selected' : ''); ?>><?php echo e($purok->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="form-group">
                <label class="form-label">Family Size <span style="color:var(--crimson)">*</span></label>
                <input type="number" name="family_size" class="form-control" value="<?php echo e(old('family_size', $household->family_size)); ?>" min="1" max="50" required>
            </div>
        </div>
        <div class="form-group mb-6">
            <label class="form-label">Address <span style="color:var(--crimson)">*</span></label>
            <input type="text" name="address" id="hh_address" class="form-control" value="<?php echo e(old('address', $household->address)); ?>" required>
        </div>
        <div class="form-group">
            <label class="form-check">
                <input type="checkbox" name="is_voter_household" value="1" <?php echo e(old('is_voter_household', $household->is_voter_household) ? 'checked' : ''); ?>>
