...
<div class="no-print" style="display:flex;align-items:center;gap:12px;background:var(--navy);border-radius:var(--radius);padding:12px 18px;margin-bottom:20px">
    ...
    <div style="flex:1;min-width:0">
        ...
        <div id="docRefNum" style="font-size:17px;font-weight:700;color:#fff;font-family:'Courier New',monospace;letter-spacing:0.05em"><?php echo e($document->doc_number); ?></div>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="card">
            <div style="background:linear-gradient(135deg,var(--navy),var(--navy-mid));padding:24px 20px;text-align:center">
                ...
                ?>
                <span class="badge" style="<?php echo e($badgeStyle); ?>"><?php echo e($document->status); ?></span>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0">
                <?php
                    ...
                    $details = [
                        ...
                        ['label'=>'Date Requested',   'value'=>$document->created_at->format('m/d/Y')],
                        ['label'=>'Date Released',    'value'=>$document->released_at?->format('m/d/Y') ?? '—'],
...
<script>
// Auto-trigger print dialog when ?print=1 is in the URL (called from documents index)
...
function copyRef() {
    var text = document.getElementById('docRefNum').textContent.trim();
