    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="card">
            <div style="background:linear-gradient(135deg,var(--navy),var(--navy-mid));padding:24px 20px;text-align:center">
                ...
                <div class="td-mono" style="color:rgba(255,255,255,0.5);font-size:11px;margin-bottom:4px"><?php echo e($document->doc_number); ?></div>
            ...
            <div style="padding:16px 20px;border-top:1px solid var(--border)">
                ...
                <a href="<?php echo e(route('residents.show', $document->resident)); ?>"
                   style="display:flex;align-items:center;gap:10px;color:var(--navy)">
                    ...
                    <div>
                        <div style="font-weight:600;font-size:13px"><?php echo e($document->resident->full_name ?? '—'); ?></div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="display:flex;flex-direction:column;gap:8px">
                ...
                <?php if($document->status === 'Pending' || $document->status === 'Processing'): ?>
                <form method="POST" action="<?php echo e(route('documents.update', $document)); ?>">
                    ...
                    <input type="hidden" name="purpose" value="<?php echo e($document->purpose); ?>">
