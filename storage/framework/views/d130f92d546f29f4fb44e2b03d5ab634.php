...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-grid-2 mb-6">
            <div class="form-group">
                ...
                <input type="text" name="respondent_name" class="form-control" value="<?php echo e(old('respondent_name')); ?>" placeholder="Full name" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="respondent_address" class="form-control" value="<?php echo e(old('respondent_address')); ?>" placeholder="Address">
            </div>
            <div class="form-group">
