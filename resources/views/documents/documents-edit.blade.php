...
<div class="card mb-6">
    ...
    <div class="card-body">
        ...
        <div id="selfPickupInfo" style="display:flex;align-items:center;gap:8px;padding:10px 14px;background:rgba(13,33,68,0.05);border:1px solid rgba(13,33,68,0.14);border-radius:var(--radius);margin-bottom:20px{{ $isRep ? ';display:none!important' : '' }}">
