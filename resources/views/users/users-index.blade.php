...
<div class="grid-3 mb-6">
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number" id="stat-total">{{ number_format($users->total()) }}</div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number" id="stat-verified">{{ number_format(\App\Models\User::whereNotNull('email_verified_at')->count()) }}</div>
...
<div class="card">
    <div class="card-header">
        ...
        <span id="stat-header-count" style="font-size:13px;color:var(--text-muted)">{{ number_format($users->total()) }} users</span>
    </div>
