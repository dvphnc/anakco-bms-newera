@extends('layouts.app')
@section('title', 'Portal Business Requests')
@section('page-title', 'Portal Business Requests')
@section('page-subtitle', 'Business permit requests submitted via the Resident Portal')
@section('content')
...
<div class="grid-4 mb-6">
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number">{{ number_format($counts['Under Review'] ?? 0) }}</div>
...
$(document).ready(function () {
    ...
    var table = $('#pbizTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('portal-business.index') }}',
            data: function (d) {
