@extends('layouts.app')
@section('title', 'Portal Blotter Requests')
@section('page-title', 'Portal Blotter Requests')
@section('page-subtitle', 'Blotter reports submitted via the Resident Portal')
@section('content')
...
<div class="grid-4 mb-6">
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number">{{ number_format($counts['For Mediation'] ?? 0) }}</div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-number">{{ number_format($resolved) }}</div>
...
$(document).ready(function () {
    ...
    var table = $('#pblTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('portal-blotter.index') }}',
            data: function (d) {
