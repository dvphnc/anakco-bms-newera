    ...
    <div class="section-inner">
        ...
        <div class="services-grid">
            <div class="service-tile">
                ...
                <a href="{{ route('portal.request') }}?type=Barangay+Clearance" class="tile-cta">
            ...
            <div class="service-tile">
                ...
                <a href="{{ route('portal.request') }}?type=Certificate+of+Indigency" class="tile-cta">
                    Apply Now <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="service-tile">
                ...
                <a href="{{ route('portal.request') }}?type=Certificate+of+Residency" class="tile-cta">
                    Apply Now <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="service-tile">
                ...
                <a href="{{ route('portal.request') }}?type=Business+Clearance" class="tile-cta">
                    Apply Now <i class="fas fa-arrow-right"></i>
                </a>
            </div>
        </div>
    ...
    <div class="section-inner">
        ...
        <div class="faq-list" role="list">
            ...
            <div class="faq-item" role="listitem">
                ...
                <div class="faq-body" role="region">
                    <div class="faq-body-inner">
                        After submitting, you will receive a unique <strong>appointment number</strong> (e.g., APT-20260515-AB12). Use the <a href="{{ route('portal.track') }}" style="color:var(--navy);font-weight:600">Track My Status</a> page and enter this number to check your current status at any time.
                    </div>
                </div>
            </div>
