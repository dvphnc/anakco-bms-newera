    ...
    <div class="section-inner">
        ...
        <div class="services-grid">
            ...
            <div class="svc-card">
                ...
                <a href="{{ route('portal.request') }}?type=Business+Clearance" class="svc-card-link">
                    Request Now <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="svc-card">
                ...
                <a href="{{ route('portal.blotter') }}" class="svc-card-link">
            ...
            <div class="svc-card">
                ...
                <a href="{{ route('portal.business') }}" class="svc-card-link">
