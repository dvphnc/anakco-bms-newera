...
class ExportController extends Controller
{
    ...
    public function analytics(Request $request, string $format)
    {
        ...
        if ($format === 'pdf') {
            ...
            ))->setPaper('a4','portrait')->download("population-summary-{$date}.pdf");
        }
        ...
        $sheet->fromArray(['Male',$totalMale,$total>0?round(($totalMale/$total)*100).'%':'0%'], null, "A{$row}"); $row++;
        $sheet->fromArray(['Female',$totalFemale,$total>0?round(($totalFemale/$total)*100).'%':'0%'], null, "A{$row}"); $row++;
