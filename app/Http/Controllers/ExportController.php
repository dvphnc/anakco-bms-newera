...
class ExportController extends Controller
{
    ...
    private function addMetaSheet($spreadsheet, string $module, int $count, string $generatedBy): void
    {
        ...
        $meta->setCellValue('A4', 'Generated By');
        $meta->setCellValue('B4', $generatedBy);
        $meta->setCellValue('A5', 'Generated At');
        $meta->setCellValue('B5', now()->format('F d, Y h:i A'));
        $meta->setCellValue('A6', 'Barangay');
        $meta->setCellValue('B6', 'Barangay New Era, Quezon City');
